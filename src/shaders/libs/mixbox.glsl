// Requirements: (What you should add in your shader manually)
// uniform sampler2D mixbox_lut;

// NOTE(Dove):
//  All #define has been manually applied, i dont want to implement a complex 
//  glsl preprocessor.
...
vec4 MIXBOX_LUT(vec2 uv) {
    return textureLod(mixbox_lut, uv, 0.0);
}
